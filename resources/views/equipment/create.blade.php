...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('equipments.store') }}" method="POST">
            ...
            {{-- ═══════════════════════════════════════════════════════════════
                 2. PIANIFICAZIONE MANUTENZIONE (impianto principale)
                 ═══════════════════════════════════════════════════════════════ --}}
            <hr class="my-4">
            ...
            <div x-data="planningSection({
                ...
                situation: '{{ old('maintenance_situation', 'mai') }}',
                frequency: {{ old('maintenance_frequency_days', 30) }},
                lastDate: '{{ old('last_maintenance_date') }}',
                firstDate: '{{ old('first_intervention_date') }}',
                manualOverride: '{{ old('next_maintenance_date') }}',
            })">
                {{-- Assegnazione --}}
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" maxlength="255" required
                           ...
                           value="{{ old('intervention_title') }}"
                           placeholder="Es. Manutenzione ordinaria filtri">
                ...
                <div class="mb-3">
                    ...
                    <textarea rows="3" class="form-control @error('intervention_description') is-invalid @enderror"
                              id="intervention_description" name="intervention_description"
                              placeholder="Attività da svolgere ad ogni ciclo">{{ old('intervention_description') }}</textarea>
                    @error('intervention_description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3" x-show="situation === 'mai'">
                        ...
                        <input type="date" class="form-control @error('first_intervention_date') is-invalid @enderror"
                               ...
                               x-model="firstDate">
                        <small class="form-text text-muted">Il sistema creerà subito il primo ticket pianificato per questa data.</small>
            ...
            {{-- ═══════════════════════════════════════════════════════════════
                 ...
                 ═══════════════════════════════════════════════════════════════ --}}
            <hr class="my-4">
            <div x-data="componentsManager({{ json_encode(old('components', [])) }}, @json($maintenanceRoles), @json($manutentori))">
                ...
                <small class="text-muted d-block mb-3">
                    Ogni componente è indipendente dall'impianto principale e genera ticket separati con il proprio ciclo.
                </small>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm"
                                       ...
                                       placeholder="Es. Sostituzione filtri">
                            </div>
