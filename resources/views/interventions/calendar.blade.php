...
const priorityLabels = { low: 'Bassa', medium: 'Media', high: 'Alta', fixed_date: 'Data fissa' };
const priorityColors = { low: '#6c757d', medium: '#0dcaf0', high: '#ffc107', fixed_date: '#6f42c1' };
const priorityBgClasses = { low: 'bg-secondary', medium: 'bg-info', high: 'bg-warning', fixed_date: 'bg-purple' };
